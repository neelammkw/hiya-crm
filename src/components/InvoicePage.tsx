        ...
        <View className="flex" pdfMode={pdfMode}>
          ...
          <View className="w-40 " pdfMode={pdfMode}>
             <EditableFileImage
              ...
              defaultImage="../images/ENTERPRISE.jpg"
              pdfMode={pdfMode}
          ...
          <View className="w-50 pr-5" pdfMode={pdfMode}>
            <EditableInput
              className="fs-30 right bold mb-5"
              placeholder="Invoice"
              value={invoice.title}
            ...
            <View className="flex" pdfMode={pdfMode}>
              <View className="right w-60 " pdfMode={pdfMode}>
                <EditableInput
                  className="bold right"
              ...
              <View className="w-60 right" pdfMode={pdfMode}>
                <EditableCalendarInput className=" right"
        ...
        {invoice.productLines.map((productLine, i) => {
          return pdfMode && productLine.description === '' ? (
            ...
            <View key={i} className="row flex" pdfMode={pdfMode}>
              <View className="w-60 p-4-8 pb-5" pdfMode={pdfMode}>
                <EditableTextarea
                  className="dark"
                  rows={2}
